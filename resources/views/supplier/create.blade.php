                        ...
                        <div class="row">
                            <div class="flex items-center gap-4">
                                <p class="bread"><span><a href="{{ route('supplier.suppliers') }}"
                                    ...
                                    / <span>เพิ่มข้อมูลผู้จัดจำหน่าย</span></p>
                            </div>
                            @if (session('status'))
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="supplier_name" id="supplier_name"
                                                name="supplier_name" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="supplier_customer_name" id="supplier_customer_name"
                                                name="supplier_customer_name" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="supplier_product" id="supplier_product"
                                                name="supplier_product" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="supplier_contact_number" id="supplier_contact_number"
                                                name="supplier_contact_number" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="supplier_email" id="supplier_email"
                                                name="supplier_email" type="email" class="mt-1 block w-full"
    ...
    <script>
        $(document).ready(function(){
            $('#submit-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('supplier.store') }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response){
                        ...
                        alert('เพิ่มข้อมูลผู้จัดจำหน่ายเรียบร้อยแล้ว');
