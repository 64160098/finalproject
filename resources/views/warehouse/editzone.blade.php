                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                            <form action="{{ route('warehouse.editzone.update', $zone->id) }}" method="POST"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex flex-wrap gap-4">
                                        ...
                                        <div class="w-1/2">
                                            ...
                                            <x-text-input id="product_name" name="product_name" type="text" value="{{ $product->product_name }}" style="width: 300px;" readonly />
                                            @error('product_name')
                                    ...
                                    <div class="flex items-center mt-4">
                                        <div class="flex items-center">
                                            <div class="w-24">
                                                ...
                                                <x-text-input id="product_width" name="product_width" type="text" value="{{ $product->product_width }}" style="width: 80px;" readonly />
                                                @error('product_width')
                                            ...
                                            <div class="w-24">
                                                ...
                                                <x-text-input id="product_length" name="product_length" type="text" value="{{ $product->product_length }}" style="width: 80px;" readonly />
                                            ...
                                            <div class="w-24">
                                                ...
                                                <x-text-input id="product_height" name="product_height" type="text" value="{{ $product->product_height }}" style="max-width: 80px;" readonly />
                                            ...
                                            <div class="w-24">
                                                ...
                                                <x-text-input id="product_volume" name="product_volume" type="text" value="{{ $product->product_volume }}" style="max-width: 200px;" readonly />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="id" name="id" type="text" value="{{ $zone->id }}" class="mt-1 block w-full" style="width: 200px;" required placeholder="รหัสโซน"/>
                                    </div>
                                    <hr class="my-4 border-gray-300 dark:border-gray-700">
                                    <div>
                                        <x-input-label for="name" :value="__('ชื่อโซน')" />
                                        <x-text-input id="name" name="name" type="text" value="{{ $zone->name }}" class="mt-1 block w-full" style="width: 200px;" required placeholder="ชื่อโซน"/>
                                    </div>
                                    ...
                                    <hr class="my-4 border-gray-300 dark:border-gray-700">
                                        ...
                                        <div class="w-24">
                                            ...
                                            <x-text-input id="zone_width" name="zone_width" value="{{ $zone->zone_width }}" type="text" class="mt-1 block" style="width: 80px;" required placeholder="กว้าง"/>
                                        </div>
                                        ...
                                        <div class="w-24">
                                            ...
                                            <x-text-input id="zone_length" name="zone_length" value="{{ $zone->zone_length }}" type="text" class="mt-1 block" style="width: 80px;" required placeholder="ยาว"/>
                                        </div>
                                        ...
                                        <div class="w-24">
                                            ...
                                            <x-text-input id="zone_height" name="zone_height" value="{{ $zone->zone_height }}" type="text" class="mt-1 block" style="width: 80px;" required placeholder="สูง"/>
                                        </div>
                                    </div>
                                    <hr class="my-4 border-gray-300 dark:border-gray-700">
                                    <div>
                                        <x-input-label for="zone_status" :value="__('สถานะ')" />
                                        <x-text-input id="zone_status" name="zone_status" value="{{ $zone->zone_status }}" type="text" class="mt-1 block w-full" style="width: 200px;" required placeholder="สถานะ"/>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            $('#update-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('warehouse.editzone.update', $zone->id) }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
