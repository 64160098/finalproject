                        ...
                        <div class="row">
                            <div class="flex items-center gap-4">
                                <p class="bread"><span><a href="{{ route('warehouse.warehouses') }}"
                                    ...
                                    / <span>เพิ่มข้อมูลคลังสินค้า</span></p>
                            </div>
                            @if (session('status'))
                                ...
                                <div class="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <x-text-input wire:model="name" id="name"
                                                name="name" type="text" class="mt-1 block w-full"
                                        ...
                                        <div>
                                            ...
                                            <x-text-input wire:model="address" id="address"
                                                name="address" type="text" class="mt-1 block w-full"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div>
                                                ...
                                                <x-text-input wire:model="warehouse_total_area" id="warehouse_total_area"
                                                    name="warehouse_total_area" type="text" class="mt-1 block w-full"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div>
                                                ...
                                                <x-text-input wire:model="warehouse_available_area" id="warehouse_available_area"
                                                    name="warehouse_available_area" type="text" class="mt-1 block w-full"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div>
                                                ...
                                                <x-text-input wire:model="warehouse_width" id="warehouse_width"
                                                    name="warehouse_width" type="text" class="mt-1 block w-full"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div>
                                                ...
                                                <x-text-input wire:model="warehouse_length" id="warehouse_length"
                                                    name="warehouse_length" type="text" class="mt-1 block w-full"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div>
                                                ...
                                                <x-text-input wire:model="warehouse_height" id="warehouse_height"
                                                    name="warehouse_height" type="text" class="mt-1 block w-full"
                                        ...
                                        <div>
                                            ...
                                            <x-text-input wire:model="warehouse_area_type" id="height"
                                                name="warehouse_area_type" type="text" class="mt-1 block w-full"
    ...
    <script>
        $(document).ready(function(){
            $('#submit-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('warehouse.store') }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response){
                        ...
                        alert('เพิ่มข้อมูลคลังสินค้าเรียบร้อยแล้ว');
