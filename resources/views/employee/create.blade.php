                        ...
                        <div class="row">
                            <div class="flex items-center gap-4">
                                <p class="bread"><span><a href="{{ route('employee.employees') }}"
                                    ...
                                    / <span>เพิ่มข้อมูลพนักงาน</span></p>
                            </div>
                            @if (session('status'))
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="employee_firstname" id="employee_firstname"
                                                name="employee_firstname" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="employee_lastname" id="employee_lastname"
                                                name="employee_lastname" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="employee_contact_number" id="employee_contact_number"
                                                name="employee_contact_number" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="employee_email" id="employee_email"
                                                name="employee_email" type="email" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="employee_status" id="employee_status"
                                                name="employee_status" type="text" class="mt-1 block w-full"
    ...
    <script>
        $(document).ready(function(){
            $('#submit-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('employee.store') }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
