                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="id" id="id"
                                                name="id" value="{{ $product->id }}" type="text" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="product_name" id="product_name"
                                                name="product_name" value="{{ $product->product_name }}" type="text" class="mt-1 block w-full"
                                                required autofocus autocomplete="product_name" placeholder="ชื่อสินค้า"/>
                                                <div class="alert alert-danger" id="product_name_error"></div>
                                            @error('product_name')
                                                <div class="aleart alert-success">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div>
                                            <div class="flex items-center">
                                                ...
                                                <div class="w-24">
                                                    ...
                                                    <x-text-input wire:model="product_width" id="product_width" name="product_width" type="text" value="{{ $product->product_width }}" class="mt-1 block" required autofocus autocomplete="product_width" style="max-width: 50px;" />
                                                    @error('product_width')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="w-24">
                                                    ...
                                                    <x-text-input wire:model="product_length" id="product_length" name="product_length" type="text" value="{{ $product->product_length }}" class="mt-1 block" required autofocus autocomplete="product_length" style="max-width: 50px;" />
                                                ...
                                                <div class="w-24">
                                                    ...
                                                    <x-text-input wire:model="product_height" id="product_height" name="product_height" type="text" value="{{ $product->product_height }}" class="mt-1 block" required autofocus autocomplete="product_height" style="max-width: 50px;" />
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="price" id="price"
                                                name="price" value="{{ $product->price }}" type="text" class="mt-1 block w-full"
    ...
    <script>
        $(document).ready(function(){
            $('#update-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('product.update', $product->id) }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
