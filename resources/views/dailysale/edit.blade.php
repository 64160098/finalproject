                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                            <form id="dailyForm" action="{{ route('dailysale.user.update', $dailysale->id) }}" method="POST"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <x-text-input id="total_earning" value="{{ $dailysale->total_earning }}" name="total_earning" type="number" class="mt-1 block w-full" style="max-width: 300px;" required autofocus autocomplete="total_earning" placeholder="รายได้ทั้งหมด" />
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <x-text-input id="scan_to_pay" value="{{ $dailysale->scan_to_pay }}" name="scan_to_pay" type="number" class="mt-1 block w-full" style="max-width: 300px;" required autofocus autocomplete="scan_to_pay" placeholder="ยอดโอน" />
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <x-text-input id="cash" name="cash" value="{{ $dailysale->cash }}" type="number" class="mt-1 block w-full" style="max-width: 300px;" required autofocus autocomplete="cash" placeholder="เงินสด" />
    ...
    <script>
        $(document).ready(function(){
            $('#update-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('dailysale.user.update', $dailysale->id) }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
