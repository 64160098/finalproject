                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                                <form id="productsaleForm" action="{{ route('productsalereport.history.update', $productsalereport->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="space-y-6">
    ...
    <script>
        $(document).ready(function(){
            $('#update-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('productsalereport.history.update', $productsalereport->id) }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
