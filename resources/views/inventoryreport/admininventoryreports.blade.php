    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end">
                <form method="GET" action="{{ route('inventoryreport.admininventoryreports') }}" class="flex items-center">
                            ...
                            <table id="producttable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="10%" align="left" valign="middle"><strong>คงเหลือ</strong></td>
                                    ...
                                    @foreach ($admininventoryreports as $admininventoryreport)
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->code }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->product_name }}</td> 
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->quantity_inventories }}</td>                              
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->unit }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->cost_unit }}</td> 
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->total }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->created_at ? $admininventoryreport->created_at->translatedFormat('d M Y') : '' }}</td>
                                        <td width="10%" align="center" valign="middle">
                                            <a href="{{ route('admininventoryreport.edit', $admininventoryreport->id) }}">
                                        ...
                                        <td width="10%" align="center" valign="middle"> 
                                            <a href="#" class="delete-button" data-id="{{ $admininventoryreport->id }}">
                                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        $('.delete-button').click(function(event){
            ...
            if (confirmDelete) {
                ...
                $.ajax({
                    url: "{{ route('admininventoryreport.destroy', ':id') }}".replace(':id', productId),
                    type: 'DELETE',
                    data: {
                        "_token": "{{ csrf_token() }}"
                    },
                    success: function(response){
                        ...
                        window.location.href = "{{ route('inventoryreport.admininventoryreports') }}";
                    },
                    error: function(xhr){
