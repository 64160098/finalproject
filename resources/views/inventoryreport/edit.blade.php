                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                                <form id="inventoryreportForm" action="{{ route('inventoryreport.user.update', $inventoryreport->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="space-y-6">
    ...
    <script>
        $(document).ready(function(){
            $('#update-button').click(function(event){
                ...
                $.ajax({
                    url: '{{ route('inventoryreport.user.update', $inventoryreport->id) }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
