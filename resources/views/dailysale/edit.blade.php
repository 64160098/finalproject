                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                            <form action="{{ route('dailysale.update', $dailysale->id) }}" method="POST"
                                ...
                                <div class="space-y-6">
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="sale_date" id="sale_date"
                                                name="sale_date" value="{{ $dailysale->sale_date }}" type="date" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="total_earning" id="total_earning"
                                                name="total_earning" value="{{ $dailysale->total_earning }}" type="number" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="Scan_to_pay" id="Scan_to_pay"
                                                name="Scan_to_pay" value="{{ $dailysale->Scan_to_pay }}" type="number" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="cash" id="cash"
                                                name="cash" value="{{ $dailysale->cash }}" type="number" class="mt-1 block w-full"
                                    ...
                                    <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                        <div>
                                            ...
                                            <x-text-input wire:model="cash" id="cash"
                                                name="reporter_name" value="{{ $dailysale->reporter_name }}" type="text" class="mt-1 block w-full"
