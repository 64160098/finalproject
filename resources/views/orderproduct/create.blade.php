                    ...
                    <div class="contrainer mt-2">
                        <div class="row">
                            <div class="flex items-center gap-4">
                                <p class="bread"><span><a href="{{ route('orderproduct.orderproducts') }}"
                                    ...
                                    <table id="producttable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                        <tbody>
                                            ...
                                            @foreach ($products as $product)
                                                <form action="{{ route('orderproduct.store') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <table width="100%" border="1" cellpadding="5" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td width="10%" align="left" valign="middle">
                                                                <x-text-input id="quantity_products_order{{$product->id}}" 
                                                                              name="quantity_products_order{{$product->id}}" 
                                                                              type="number" class="mt-1 block w-full" 
                                                                              required autofocus 
                                                                              autocomplete="quantity_products_order{{$product->id}}" 
                                                                              placeholder="1"/>
                                                            </td>
