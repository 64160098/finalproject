    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end">
                <form method="GET" action="{{ route('productsalereport.productsalehistorys') }}" class="flex items-center">
                        ...
                        <div class="space-y-6">
                            ...
                            <table id="producttable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->code }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->product_name }}</td> 
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->quantity_products_sale }}</td>                              
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->unit }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->cost_unit }}</td> 
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->total }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalehistory->created_at ? $productsalehistory->created_at->translatedFormat('d M Y') : '' }}</td>
                                        <td width="10%" align="center" valign="middle">
                                            <a href="{{ route('productsalehistory.edit', $productsalehistory->id) }}">
...
<script>
    $('.delete-button').click(function(event){
        ...
        if (confirmDelete) {
            ...
            $.ajax({
                url: "{{ route('productsalehistory.destroy', ':id') }}".replace(':id', productId),
                type: 'DELETE',
                data: {
                    "_token": "{{ csrf_token() }}"
                },
