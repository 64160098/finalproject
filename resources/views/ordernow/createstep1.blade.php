                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                                <form action="{{ route('ordernow.postStep1') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="space-y-6">
                                    <hr class="border-gray-300 dark:border-gray-700">
                                    <div class="w-1/2">
                                        <x-input-label for="id" :value="__('รหัสใบสั่งซื้อ ')" />
                                        <x-text-input id="id" value="{{ $id }}" name="id" type="text" class="mt-1 block w-full" style="max-width: 350px;" required autofocus autocomplete="id" placeholder="รหัสใบสั่งซื้อ" readonly />
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <x-text-input value="{{ $currentDate  }}" id="order_date" name="order_date" type="date" class="mt-1 block w-full" style="max-width: 300px;" required autofocus autocomplete="order_date" placeholder="วันที่สั่งซื้อ" />
