                    ...
                    <div class="container mt-2">
                        <div class="space-y-6">
                            <div class="flex justify-between">
                                <a href="{{ route('producttype.create') }}" class=""><x-primary-button>เพิ่มข้อมูล</x-primary-button></a>
                                <form method="GET" action="{{ route('producttype.index') }}">
                            ...
                            <table id="producttypetable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td width="20%" align="left" valign="middle"><strong>รหัสประเภทสินค้า</strong></td>
                                        <td width="59%" align="left" valign="middle"><strong>ประเภทสินค้า</strong></td>
                                    ...
                                    <tr>
                                        <td width="20%" align="left" valign="middle">{{ $producttype->id }}</td>
                                        <td align="left" valign="middle">{{ $producttype->product_type }}</td>
                                        ...
                                        <td width="9%" align="center" valign="middle">
                                            <a href="#" class="delete-button" data-id="{{ $producttype->id }}">
                                                <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        $('.delete-button').click(function(event){
            ...
            if (confirmDelete) {
                ...
                $.ajax({
                    url: "{{ route('producttype.destroy', ':id') }}".replace(':id', productId),
                    type: 'DELETE',
                    data: {
                        "_token": "{{ csrf_token() }}"
                    },
