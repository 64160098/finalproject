                        ...
                        <div class="space-y-6">
                            ...
                            <table width="100%" border="1" cellpadding="5" cellspacing="0" class="text-gray-900 dark:text-gray-100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $employee->id }}</td>
                                        <td width="7%" align="left" valign="middle">{{ $employee->employee_firstname }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $employee->employee_lastname }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $employee->employee_contact_number }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $employee->employee_email }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $employee->employee_status }}</td>
