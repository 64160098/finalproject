                        ...
                        <div class="space-y-6">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('product.createeoq') }}" style="margin-left: 0.5cm;">
                                        <x-primary-button style="background-color: #28A745; color: white; text-shadow: 1px 1px 2px black;">
                                            วิเคราะห์การสั่งซื้อและจุดสั่งซ้ำ
                                        </x-primary-button>
                                    </a>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="4%" align="center" valign="middle">
                                            @if ($product->eoqropCalculations->isNotEmpty())
                                                <a href="{{ route('product.detailmore', $product->id) }}">
