                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                                <form action="{{ route('admininventoryreport.update', $admininventoryreport->id) }}" method="POST"
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                            <div>
                                                ...
                                                {{ $admininventoryreport->product_name }}
                                                @error('product_name')
                                                    <div class="aleart alert-success">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                            <div>
                                                <x-input-label for="quantity_inventories" :value="__('คงเหลือ')" />
                                                <x-text-input wire:model="quantity_inventories" id="quantity_inventories"
                                                    name="quantity_inventories" value="{{ $admininventoryreport->quantity_inventories }}" type="number" class="mt-1 block w-full"
                                                    required autofocus autocomplete="quantity_inventories" placeholder="คงเหลือ"/>
                                                @error('quantity_inventories')
                                                    <div class="aleart alert-success">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex items-center gap-4">
                                            <div>
                                                ...
                                                {{ $admininventoryreport->cost_unit }}
                                                @error('cost_unit')
                                                    <div class="aleart alert-success">{{ $message }}</div>
                                                @enderror
                                            </div>
