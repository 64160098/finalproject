                        ...
                        <div class="space-y-6">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <a href="{{ route('product.create') }}"><x-primary-button>เพิ่มข้อมูล</x-primary-button></a>
                                    <a href="{{ route('product.createeoq') }}" style="margin-left: 0.5cm;"><x-primary-button>วิเคราะห์การสั่งซื้อและจุดสั่งซ้ำ</x-primary-button></a>
                                </div>
                            ...
                            <table id="producttable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="25%" align="left" valign="middle"><strong>ชื่อสินค้า</strong></td>
                                        ...
                                        <td width="10%" align="left" valign="middle"><strong>รายละเอียด</strong></td>
                                    ...
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $product->id }}</td>
                                        <td width="25%" align="left" valign="middle">{{ $product->product_name }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->productType->product_type }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->productUnit->unit }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->product_width }}×{{ $product->product_length }}×{{ $product->product_height }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->price }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->price }}</td>
                                        ...
                                        <td width="10%" align="center" valign="middle">
                                            <a href="#" class="delete-button" data-id="{{ $product->id }}">
                                                <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
