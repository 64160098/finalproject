                    ...
                    <div class="container mt-2">
                        <div class="space-y-6">
                            <div class="flex justify-between">
                                <a href="{{ route('dailysale.create') }}" class="">
                            ...
                            <table width="100%" border="1" cellpadding="5" cellspacing="0" class="text-gray-900 dark:text-gray-100">
                                ...
                                @foreach ($dailysales as $dailysale)
                                 <tr>
                                    <td width="5%" align="center" valign="middle">{{ $dailysale->sale_date ? \Carbon\Carbon::parse($dailysale->sale_date)->translatedFormat('d M Y') : '' }}</td>
                                    <td width="6%" align="center" valign="middle">{{ $dailysale->total_earning }}</td>
                                    <td width="6%" align="center" valign="middle">{{ $dailysale->scan_to_pay }}</td>
                                    <td width="6%" align="center" valign="middle">{{ $dailysale->cash }}</td>
                                    <td width="6%" align="center" valign="middle">{{ $dailysale->employee->employee_firstname  }} {{ $dailysale->employee->employee_lastname  }}</td>
                                    <td width="1%" align="center" valign="middle">
                                        <a href="{{ route('dailysale.user.edit', $dailysale->id) }}">
