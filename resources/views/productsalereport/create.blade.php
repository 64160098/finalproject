                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="contrainer mt-2">
                        <div class="row">
                            ...
                            @endif
                            <section>
                                <form id="productsaleForm" action="{{ route('productsalereport.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="space-y-6">
                                    <div class="w-1/2">
                                ...
                                <div id="total_sales" class="font-bold text-xl mt-4">ราคารวม: 0.00</div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#submit-button').click(function(event){
                ...
                var formData = new FormData($('#productsaleForm')[0]); // สร้าง FormData จากฟอร์มที่มี id="orderForm"
        
                $.ajax({
                    url: '{{ route('productsalereport.store') }}', // URL ของการส่งข้อมูล
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
