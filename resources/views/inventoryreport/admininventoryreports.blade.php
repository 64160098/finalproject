                    ...
                    <div class="container mt-2">
                        <div class="space-y-6">
                           <div class="form-container">
                                <form method="GET" action="{{ route('inventoryreport.admininventoryreports') }}">
                            ...
                            <table width="100%" border="1" cellpadding="5" cellspacing="0" class="text-gray-900 dark:text-gray-100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->transaction_date }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->employee_id  }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->employee->employee_firstname  }} {{ $admininventoryreport->employee->employee_lastname  }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $admininventoryreport->total_inventory_value }} บาท</td>
                                        <td width="4%" align="center" valign="middle">
                                            <a href="{{ route('inventoryreport.admindetailinventoryreport', $admininventoryreport->id) }}">
                                        ...
                                        <td width="1%" align="center" valign="middle">
                                            <a href="{{ route('inventoryreport.admin.edit', $admininventoryreport->id) }}">
    ...
    <script>
        $('.delete-button').click(function(event){
            ...
            if (confirmDelete) {
                ...
                $.ajax({
                    url: "{{ route('inventoryreport.destroy', ':id') }}".replace(':id', productId),
                    type: 'DELETE',
                    data: {
                        "_token": "{{ csrf_token() }}"
                    },
