...
<x-appadmin-layout>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="container mt-2">
                        <div class="space-y-6">
                            ...
                            @endif
                            <table id="producttypetable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="10%" align="left" valign="middle"><strong>จำนวน</strong></td>
                                        <td width="10%" align="center" valign="middle"><strong>แก้ไข</strong></td>
                                    </tr>
                            
                                    @foreach ($products as $product)
                                        @php
                                            $inventory = $inventories->firstWhere('code', $product->code);
                                        @endphp
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $product->code }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->product_name }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->product_type }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->unit }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->color }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->size }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $product->price }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $inventory ? $inventory->amount : '-' }}</td>
    ...
    <script>
        let table = new DataTable('#producttypetable');
    </script>
