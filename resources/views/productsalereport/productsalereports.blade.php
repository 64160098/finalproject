                    ...
                    <div class="container mt-2">
                        <div class="space-y-6">
                            <div class="flex justify-between">
                                <a href="{{ route('productsalereport.create') }}" class="">
                                    <x-primary-button style="background-color: #28A745; color: white; text-shadow: 1px 1px 2px black;">
                                        สร้างรายงานการขาย
                                    </x-primary-button>
                                </a>
                                <form method="GET" action="{{ route('productsalereport.index') }}">
                            ...
                            <table width="100%" border="1" cellpadding="5" cellspacing="0" class="text-gray-900 dark:text-gray-100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="10%" align="left" valign="middle">{{ $productsalereport->transaction_date }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalereport->employee_id  }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalereport->employee->employee_firstname  }} {{ $productsalereport->employee->employee_lastname  }}</td>
                                        <td width="10%" align="left" valign="middle">{{ $productsalereport->total_sales }} บาท</td>
                                        <td width="4%" align="center" valign="middle">
                                            <a href="{{ route('productsalereport.detailproductsale', $productsalereport->id) }}">
