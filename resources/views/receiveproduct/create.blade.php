                                    ...
                                    <table id="producttable" width="100%" border="1" cellpadding="5" cellspacing="0">
                                        <tbody>
                                            ...
                                            @foreach ($products as $product)
                                                ...
                                                @endphp
                                                <form action="{{ route('receiveproduct.store') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <table width="100%" border="1" cellpadding="5" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td width="10%" align="left" valign="middle">
                                                                <x-text-input id="quantity_products_received_{{$product->id}}" 
                                                                              name="quantity_products_received_{{$product->id}}" 
                                                                              type="number" class="mt-1 block w-full" 
                                                                              required autofocus 
                                                                              autocomplete="quantity_products_received_{{$product->id}}" 
                                                                              placeholder="1"/>
                                                            </td>
